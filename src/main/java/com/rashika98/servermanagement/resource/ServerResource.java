package com.rashika98.servermanagement.resource;

import com.rashika98.servermanagement.enumeration.Status;
import com.rashika98.servermanagement.model.Response;
import com.rashika98.servermanagement.model.Server;
import com.rashika98.servermanagement.service.implementation.ServerServiceImpl;
    ...
    public ResponseEntity<Response> getServers(){
        return ResponseEntity.ok(
                Response.builder()
                        ...
                        .message("Servers were retrieved.")
                        .status(OK)
                        .statusCode(OK.value())
                        .build()
        );
    ...
    public ResponseEntity<Response> pingServer(@PathVariable("ipAddress") String ipAddress) throws IOException {
        ...
        return ResponseEntity.ok(
                Response.builder()
                        ...
                        .message(server.getStatus() == Status.SERVER_UP ? "Ping success" : "Ping faild")
                        .status(OK)
                        .statusCode(OK.value())
                        .build()
        );
